...
public class Sha3Keccak_r544_c256 extends Sha3Keccak_W32
{
	...
	static Sha3Keccak_r544_c256 p_Instance = null;
	...
	public static Sha3Keccak_r544_c256 getInstance()
	{
		if(p_Instance == null)
			p_Instance = new Sha3Keccak_r544_c256();
		return p_Instance;
	}
}
