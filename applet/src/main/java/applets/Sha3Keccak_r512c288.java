...
public class Sha3Keccak_r512c288 extends Sha3Keccak_W32{
	
	static Sha3Keccak_r512c288 p_Instance = null;
	...
	private Sha3Keccak_r512c288()
	{
		KECCAK_VALUE_W = 32;
		KECCAK_SEC_LEVEL = 144;
		...
		KECCAK_SIZE_BYTES = 512/8;
	}
	public static Sha3Keccak_r512c288 getInstance()
	{
		if(p_Instance == null)
			p_Instance = new Sha3Keccak_r512c288();
		return p_Instance;
	}
}
