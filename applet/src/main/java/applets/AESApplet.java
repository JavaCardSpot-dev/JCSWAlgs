...
public class AESApplet extends Applet implements IConsts{
    DESKey m_key = null;
    JavaCardAES m_aes_enc = null;
    JavaCardAES m_aes_dec = null;
    boolean         m_isRealCard = false;
    private byte m_ramArray[] = null;
    final static short ARRAY_LENGTH  = (short) 64;

    protected AESApplet(byte[] buffer, short offset, byte length) {
    ...
    {
        new AESApplet(bArray, bOffset, bLength).register();
